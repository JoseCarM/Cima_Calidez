...
class Calendario extends React.Component {
  ...
  mesAnterior() {
    if (
      this.state.mesActual === this.state.mesVisible &&
      this.state.anioActual === this.state.anioVisible
    ) {
    ...
    return (
      <div id="presentacionDeCalendario">
        ...
        <div id="contenedorCalendario">
          <button onClick={this.mesAnterior}>
            <img
          ...
          <Mes
            mes={this.state.mesVisible}
            anio={this.state.anioVisible}
            // -------------
            fechaDeEntrada={this.props.fechaDeEntrada}
            fechaOcupadaMasCercanaAFechaDeEntrada={
              this.props.fechaOcupadaMasCercanaAFechaDeEntrada
            }
            fechaDeSalida={this.props.fechaDeSalida}
            fechasOcupadas={this.props.fechasOcupadas}
            cambioDeEstadoComparador={this.props.cambioDeEstadoComparador}
            cambioDeEstadoApp={this.props.cambioDeEstadoApp}
            // --------------
          />
          <Mes
            mes={this.segundoMesVisible()}
            anio={this.segundoAnioVisible()}
            // ------------
            fechaDeEntrada={this.props.fechaDeEntrada}
            fechaOcupadaMasCercanaAFechaDeEntrada={
              this.props.fechaOcupadaMasCercanaAFechaDeEntrada
            ...
            // -------------
          />
          <button onClick={this.mesSiguiente}>
            <img
              className="botonesCalendario"
              src={botonAbajoImg}
              alt="Mes siguiente"
        ...
        <div id="fechaDeEntradaYSalida">
          <table>
            ...
            <tbody>
              <tr>
                <td>
                  {fechaDeEntrada ? fechaDeEntrada.getDate() + "/" : ""}
                  {fechaDeEntrada ? fechaDeEntrada.getMonth() + "/" : ""}
                  {fechaDeEntrada ? fechaDeEntrada.getFullYear() : ""}
                </td>
                <td>
                  {fechaDeSalida ? fechaDeSalida.getDate() + "/" : ""}
                  {fechaDeSalida ? fechaDeSalida.getMonth() + "/" : ""}
                  {fechaDeSalida ? fechaDeSalida.getFullYear() : ""}
                </td>
              </tr>
            </tbody>
          </table>
