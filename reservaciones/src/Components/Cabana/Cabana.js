...
class Cabana extends React.Component {
  render() {
    let precio = calculadoraDePrecios(
      this.props.preciosBase[`cabana${this.props.cabana}`],
      this.props.huespedes.numeroDeAdultos,
      this.props.huespedes.numeroDeNinos,
      this.props.minimoDeHuespedes[`cabana${this.props.cabana}`],
      this.props.maximoDeHuespedes[`cabana${this.props.cabana}`],
      this.props.huespedes.numeroDeMascotas,
      numeroDeDiasEntreFechas(
    ...
    return (
      <div id="cabana">
        ...
        <div id="cabanaInformacion">
          ...
          <img
            src={imagenesDePortada[this.props.cabana]}
            alt="Portada de cabaña"
          ></img>
          <h2
            id={precio ? "precioVisible" : "precioNoVisible"}
          >{`Total: $${precio}`}</h2>
          <div id="contenedorDeBotones">
            ...
            <Reservar
              ...
              cambioDeEstadoApp={this.props.cambioDeEstadoApp}
              precio={precio}
              cabanasARentar={[this.props.cabana]}
              fechaDeEntrada={this.props.fechaDeEntrada}
              fechaDeSalida={this.props.fechaDeSalida}
            />
          </div>
