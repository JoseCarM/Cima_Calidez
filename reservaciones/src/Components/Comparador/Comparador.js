...
class Comparador extends React.Component {
  ...
  toggleTipoDeBusqueda() {
    this.state.busquedaCombinada
      ? this.setState({ busquedaCombinada: false })
      : this.setState({ busquedaCombinada: true });
  }
  componentDidMount() {
      ...
      <div id="comparador">
        <div id="calendarioYCantidadDeHuespedes">
          <Calendario
            ...
            cambioDeEstadoComparador={this.cambioDeEstadoComparador}
          ...
          <div id="cantidadDeHuespedesYBuscar">
            ...
            />
            <button
              onClick={this.toggleTipoDeBusqueda}
        ...
        <ListaDeResultados
          ...
          nuevaBusqueda={this.state.nuevaBusqueda}
          busquedaCombinada={this.state.busquedaCombinada}
          huespedes={this.props.huespedes}
          preciosBase={this.props.preciosBase}
          minimoDeHuespedes={this.props.minimoDeHuespedes}
          maximoDeHuespedes={this.props.maximoDeHuespedes}
          numeroDeNoches={numeroDeDiasEntreFechas(
            this.props.fechaDeEntrada,
            this.props.fechaDeSalida
          )}
          fechaDeEntrada={this.props.fechaDeEntrada}
          fechaDeSalida={this.props.fechaDeSalida}
          cambioDeEstadoApp={this.props.cambioDeEstadoApp}
