    ...
    renderizaOpciones(tipo, cantidad){
        return (
                <tr className='tipoDeHuesped'>
                    <td id='nombreDeTipo'><p>{`${tipo}: `}</p></td>
                    <td>
                        <button className='botonesHuespedes' onClick={() => this.cambiarNumeroDeHuespedes(tipo, cantidad, 'disminuye')}>-</button><p>{cantidad}</p><button className='botonesHuespedes' onClick={() => this.cambiarNumeroDeHuespedes(tipo, cantidad, 'aumenta')}>+</button>
                    </td>
                </tr>
        )
    }
