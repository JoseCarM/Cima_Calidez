        ...
        combinacion.forEach(cabana => {
            opcion.push(
                <div className='cabanaDeOpcion' key={cabana}>
                    ...
                    <img className='portadasResultados' src={imagenesDePortada[cabana]} alt={`Cabaña ${cabana}`}/>
                    <MasDetalles />
                </div>
            );
        })
    ...
    render(){
        return(
            <div className='opcionesResultadosCombinados'>
                ...
                <Reservar visibilidad={true} cambioDeEstadoApp={this.props.cambioDeEstadoApp} precio={this.props.precio} cabanasARentar={this.props.combinacion}/>
            </div>
        )
    }
}
